...
export function HomePage({ content }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#070909] text-[#f4f1ea]">
      ...
      <main>
        ...
        <section
          ...
          className="ambient-gradient relative overflow-hidden bg-[linear-gradient(180deg,#070909_0%,#121a1b_42%,#0d1213_72%,#080a0a_100%)] py-20 lg:py-28"
        >
          ...
          <div className="absolute right-[-14rem] top-10 h-[30rem] w-[30rem] rounded-full bg-[#b7c7d8]/22 blur-3xl" />
          <div className="absolute bottom-[-12rem] left-1/2 h-[36rem] w-[36rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(126,147,169,0.24),rgba(216,210,196,0.1),transparent_68%)] blur-3xl" />
          <div className="page-shell grid gap-8 lg:grid-cols-[0.84fr_1.16fr] lg:items-stretch">
            <div className="glass-hover-sweep relative overflow-hidden rounded-[1.5rem] border border-transparent bg-[linear-gradient(145deg,rgba(255,255,255,0.1),rgba(255,255,255,0.032))_padding-box,linear-gradient(135deg,rgba(244,241,234,0.44),rgba(132,154,176,0.3),rgba(103,88,146,0.14),rgba(244,241,234,0.08))_border-box] p-7 shadow-[0_28px_90px_rgba(0,0,0,0.34)] backdrop-blur sm:p-9">
